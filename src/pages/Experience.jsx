    ...
    >
      ...
      >
        ...
        <div className="flex flex-wrap items-baseline justify-between gap-2">
          <p className="label text-violet">{now.eyebrow}</p>
        ...
        <p className="mt-3 text-body-sm leading-relaxed text-mist md:text-body-lg">{now.body}</p>
        ...
        {track.map((role, i) => (
          ...
          >
            <div className="flex flex-wrap items-baseline justify-between gap-2">
              ...
              <span className="label text-violet">{role.tag}</span>
            </div>
      ...
      <motion.section
        ...
        className="mt-14"
      >
        <p className="mb-5 label text-fog">
          Education &amp; Campus
        </p>
        <div className="grid gap-4 sm:grid-cols-2">
          {education.map((e) => (
            <article key={e.id} className="glass flex flex-col p-6 md:p-7">
              ...
              <p className="mt-0.5 text-body-sm text-fog">{e.detail}</p>
              <p className="text-micro text-fog">{e.meta}</p>
              <p className="mt-3 text-body-sm leading-relaxed text-mist">{e.note}</p>
            </article>
          ))}
        </div>
      </motion.section>
